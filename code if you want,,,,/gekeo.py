...
def shiny_font_change():
    ...
    sonty = tk.font.Font(family=selected,size=12)
...
def open_shiny():
    ...
    for item in range(len(fonts)):
        shinymenu['menu'].entryconfig(item, font=font.Font(family=fonts[item], size=12))
...
title = window.title("Cyggy's Sekaiju Calculator v1.4")
